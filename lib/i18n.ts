...
const DICT: Dict = {
  ...
  f_area_search: { en: 'Search for an area…', ar: 'ابحث عن منطقة…' },
  f_area_none: { en: 'No matching areas', ar: 'لا توجد مناطق مطابقة' },
  f_governorate_all: { en: 'All governorates', ar: 'كل المحافظات' },
  ...
  f_construction_pct: { en: 'Enter a valid percentage', ar: 'أدخل نسبة صحيحة' },
  ...
  criteria_delete_warn: { en: 'This criteria is assigned to {requests} request(s) and has {measures} recorded measure(s) (including their notes, ratings, and photos). Deleting it will permanently remove the criteria and all of that data from every request. This cannot be undone. Continue?', ar: 'هذا البند مُعيَّن على {requests} طلب/طلبات ويحتوي على {measures} قياسًا مُسجّلًا (بما في ذلك الملاحظات والتقييمات والصور). حذفه سيؤدي إلى إزالة البند وكل تلك البيانات نهائيًا من جميع الطلبات. لا يمكن التراجع عن هذا الإجراء. هل تريد المتابعة؟' },
